...
export default function ConsultationBooking() {
  ...
  const doctors = [
    ...
    { 
      ...
      name: 'Dr. Suhas Sakhare', 

      photo: './drsuhas.png', 

      degrees: 'MD, PhD, DYT', 

      desc: 'Ayurvedic Gastroenterologist', 
      ...
      availability: 'Mon-Sat, 11:00 AM - 6:00 PM IST', 

      expertise: ['Ulcerative Colitis', 'Crohn’s Disease', 'IBS'] 
    ...
    { 
      ...
      expertise: ['Psoriasis', 'Acne', 'Fatty Liver'] 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.paymentSessionId) {
        ...
        // Use window.Cashfree as it is loaded from CDN
  ...
  if (isSuccess) {
    ...
    return (
      ...
      <div className="min-h-screen flex items-center justify-center bg-green-50 text-green-900">
        ...
        <div className="text-center p-10 bg-white rounded-3xl shadow-xl border border-green-200">

          <h2 className="text-3xl font-bold mb-4">Payment Successful!</h2>

          <p>Your consultation with {form.doctor} is confirmed.</p>
    ...
    <div className="min-h-screen bg-white to-[#fef6df] text-gray-800 font-sans">
      ...
      {/* 
        ...
        <footer className="bg-white text-center text-gray-500 py-6 text-sm border-t mt-12">
          ...
          <div>© 2026 Yukti Herbs. All rights reserved.</div>
